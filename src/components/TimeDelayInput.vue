<template>
  ...
  <div class="time-delay-input">
    <div class="time-delay-content">
      ...
      <div>
        <!-- Sequential Batch Final Position Selector - now shown after the initial batch calculation -->
        <div class="sequential-final-position" v-if="gcStore.calculationAttempted">
          <label>
